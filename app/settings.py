...
DATABASES = {
    "default": {
        ...
        "USER": os.environ.get('UMAP_DB_USER', 'umap'),
        "PASSWORD": os.environ.get('UMAP_DB_PASSWORD', '123456'),
        "HOST": os.environ.get('UMAP_DB_HOST', 'localhost'),
...
# Customization
UMAP_CUSTOM_TEMPLATES=os.environ.get('UMAP_CUSTOM_TEMPLATES', '/app/custom/templates')
UMAP_CUSTOM_STATICS=os.environ.get('UMAP_CUSTOM_STATICS', '/app/custom/static')
